...
export function HomeFounder() {
  return (
    <section id="about" className="py-20 md:py-24">
      <div className="page-shell grid items-start gap-10 md:grid-cols-[auto_1fr] md:gap-16">
        ...
        <div className="max-w-2xl">
          ...
          <h2 className="mt-3 text-[2.15rem] font-semibold tracking-[-0.03em] text-ink md:text-[2.75rem]">
            Adam Moreno
          </h2>
