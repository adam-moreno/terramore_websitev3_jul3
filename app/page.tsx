  ...
  const flashCards = [
    {
      ...
      color: "bg-blue-600",
      content: "Terramore is a full-service marketing agency that helps both <strong>PRODUCT</strong> and <strong>SERVICE</strong> businesses scale. Take a look at these common problems and solutions we provide our clients."
    },
    {
      ...
      <div className="relative px-6 bg-white pt-32 md:pt-40 lg:pt-52 pb-12 md:pb-16 lg:pb-16">
        <div className="max-w-7xl mx-auto">
          <div className="relative flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-4 lg:gap-16">
            ...
            <div className="hidden lg:block absolute right-0 top-1/2 translate-y-56">
